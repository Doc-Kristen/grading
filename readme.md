...
Время затраченное на разработку проекта: 30:00:00

Escape Room — сайт компании, которая занимается проведением игровых квестов разной тематики и уровня сложности.
Работа, выполненная в рамках грейдирования по профессии "React-разработчик" от HTML-Academy. 
Стек: React, TypeScript, Redux.

[Посмотреть демо](https://doc-kristen-grading.vercel.app)
